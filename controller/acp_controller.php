	...
	public function display_options()
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (empty($errors))
			{
				...
				$this->config->set('andreask_secretsanta_goodbye', $this->request->variable('andreask_secretsanta_goodbye', 0));
		...
		$this->template->assign_vars([
			...
			'ANDREASK_SECRETSANTA_GOODBYE'	=> (bool) $this->config['andreask_secretsanta_goodbye'],
		]);
	}
